...
<!--Carousel Wrapper-->
		...
		<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
			...
			<!--Slides-->
<div class="carousel-inner align-content-md-center" role="listbox">
...
<!-- Slider Card-->
  <section class="container mx-auto p-t-10">


   <div class="border border-dark card-body text-center">        
<!-- Saludo-->
      <div class="sec-title p-b-10 p-l-15 p-r-5">
                  ...
                  <div class="row ">
                     ...
                     <div class="col-md-6 px-3">
                        <div class="card-block px-3">
                           ...
                           <p class="card-text">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                              minim
                           </p>
                        </div>
                     </div>
...
<!--Botones -->
          <a class="carousel-control-prev" href="#recipeCarousel" role="button" data-slide="prev">
            <i class="fa fa-chevron-circle-left fa-2x indigo-text" aria-hidden="true"></i>
          </a>

          <a class="carousel-control-next" href="#recipeCarousel" role="button" data-slide="next">
            <i class="fa fa-chevron-circle-right fa-2x indigo-text" aria-hidden="true"></i>
          </a>
<!-- Fin botones -->
        </div>
      </div>
